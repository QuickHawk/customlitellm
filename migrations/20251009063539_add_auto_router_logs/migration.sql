...
-- CreateTable
CREATE TABLE "auto_router_logs" (
    "auto_router_log_id" TEXT NOT NULL,
    "prompt" TEXT,
    "response" TEXT,
    ...
    CONSTRAINT "auto_router_logs_pkey" PRIMARY KEY ("auto_router_log_id")
);
...
-- CreateIndex
CREATE INDEX "auto_router_logs_created_at_idx" ON "auto_router_logs"("created_at");
